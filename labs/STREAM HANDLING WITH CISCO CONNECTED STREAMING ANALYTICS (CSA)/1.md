...
![alt-tag](https://github.com/lpalamth/data-dev-learning-labs/blob/master/labs/develop-stream-handler-cisco-csa/assets/images/.jpeg?raw=true)
...
* The tasks should be in running status and the colour of the icon should be Green. Please refer screenshot below:

![alt-tag](https://github.com/lpalamth/data-dev-learning-labs/blob/master/labs/develop-stream-handler-cisco-csa/assets/images/.jpeg?raw=true)

* If any of the tasks is in stopped status then click on it to start again. Please refer screenshot below:
