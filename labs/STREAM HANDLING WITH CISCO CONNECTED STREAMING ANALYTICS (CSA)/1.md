...
P.S: This is a web Server live streaming Log visualisation.The Red line depicts Http 400 hit and the blue line depicts Http 200.You can view the number of web server hits in a specific time frame and evaluate the success and failures(Http 400 represents failure and Http 200 represents success).
