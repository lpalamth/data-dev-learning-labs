# <center>INTRODUCTION TO APACHE HADOOP ECOSYSTEM</center>
...
![alt-tag](https://github.com/lpalamth/data-dev-learning-labs/blob/master/labs/An Introduction to Hadoop EcoSystem/assets/images/HadoopBasic1.png?raw=true)

###### Step 9:

On click of Start button, user will be navigated to a workspace page where all the components - IDE, Tools and Microservices required to execute the program are available. Please refer the screenshot below:

![alt-tag](https://github.com/lpalamth/data-dev-learning-labs/blob/master/labs/An Introduction to Hadoop EcoSystem/assets/images/HadoopBasic2.png?raw=true)
