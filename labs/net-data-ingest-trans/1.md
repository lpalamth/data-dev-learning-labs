...
The transformed output data is read from HDFS and shown to the user. The generated output file is shown in section - "Data Source - file".Click on the button with an eye symbol to view the network data as shown in screenshot below.

![alt-img](https://github.com/CiscoDevNet/data-dev-learning-labs/blob/master/labs/net-data-ingest-trans/assets/images/NetworkDataIngestion6.png?raw=true)
