...
2. Select the <b>package</b> and click on blue button to build. 
   After successfull build process, change it to <b>run</b> and then click on <b>Blue</b> button again.
