...
## Step 4: Ploting the cosine signal.
...
```
Copy the above code in Zeppelin notebook UI and execute the code by clickin on the <b>Execute</b> button. This code will generate and display the Cosine curve on Zeppelin.
