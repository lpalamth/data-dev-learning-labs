...
<b>N.B: For learning, we only use small set of data for streaming in our sample application and because of that, different face image are getting generated and saved in the hadoop platform based on every changes of timestamp. This process will continue till the stream data get finished.</b></br>
