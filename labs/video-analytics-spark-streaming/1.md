...
In this lab we will integrate Spark Streaming and Kafka, detect a human face using OpenCV from a video streaming, and then save the results to a file in Hadoop environment. </br>
</br><b>Real use case</b></br>
...
In Lab, we replace the Live video stream with a mock video stream which is basically a store of many image files for simplicity. Please find the current lab scenario as below:</br>
