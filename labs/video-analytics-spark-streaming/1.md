...
## **Step 1: Explore the Data Learning Platform Dev Center**  

<font color='red'>Request access to the Data Learning Platform by sending a message to:</font> [datalearningplatform@cisco.com](mailto:datalearningplatform@cisco.com).



1. In DLP(Data Learning Platform) website, go to the development area by clicking Development Hub.
...
## **Step 5: Start the Video Source in DLP(Data Learning Platform)**
...
## **Step 6: View the file which has face images in DLP(Data Learning Platform)**
