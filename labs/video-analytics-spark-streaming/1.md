...
Below steps is using to start the video data broadcasting from Video data store to Kafka broker. </br>
...
2. Check the <b>Health</b>  status. It shoul be in <b>Stop</b> status at the beginning.</br>
3. Click on Right green button to start the service.  </br>
   N.B: This will start calling microservice which will start reading video streaming and push the stream data to Kafka. </br>
