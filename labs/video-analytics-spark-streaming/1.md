...
## Step 4: Live Stream Video data ingestion 

DLP Platform allow to ingest the real time video stream data to Kafka Broker. In the DLP platform, video stream data is coming from Camera. Our Custom application component is extracting face image from Video stream and save the final image into Hadoop platform. 
