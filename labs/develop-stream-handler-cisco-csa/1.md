...
![alt-tag](https://github.com/lpalamth/data-dev-learning-labs/blob/master/labs/develop-stream-handler-cisco-csa/assets/images/DevNetLanding1.jpeg?raw=true)

### <b>Step 9 : Workspace Page</b>

On click of Start button, user will be navigated to a workspace page where all the components - IDE, Tools and Microservices required to execute the program are available. Please refer the screenshot below:

![alt-tag](https://github.com/lpalamth/data-dev-learning-labs/blob/master/labs/develop-stream-handler-cisco-csa/assets/images/DevNetWrkSpcTask2.jpeg?raw=true)
...
![alt-tag](https://github.com/lpalamth/data-dev-learning-labs/blob/master/labs/develop-stream-handler-cisco-csa/assets/images/DevNetWrkSpcTask.jpeg?raw=true)
...
![alt-tag](https://github.com/lpalamth/data-dev-learning-labs/blob/master/labs/develop-stream-handler-cisco-csa/assets/images/IDE workspace 1.jpeg?raw=true)
