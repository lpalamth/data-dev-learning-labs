...
<b>	Section A: Setup The CSA Engine and Log Simulator </br>
Section B: Codeing and configure the customized CSA Handler</br>
Section C: The Visualization section with Zeppelin</b> 
...
```
<b>Tips :<b/> 5432 is default working port of Trucq CSA Engine.
</br>
