...
* The command to view the output is as follows:
...
#you could upload local file to hdfs like this:
        #create a file in local, for example, hadoop-learning-labs.txt
        echo “hello, hadoop-learning-labs” >> hadoop-learning-labs.txt
        #upload file via hdfs dfs -put or hdfs dfs -copyFromLocal command
	hdfs dfs –put hadoop-learning-labs.txt ${HDFS}learning-labs/
         
	#you’ll check the output like this:
