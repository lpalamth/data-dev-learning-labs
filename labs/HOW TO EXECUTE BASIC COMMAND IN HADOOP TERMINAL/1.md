# <center>BASIC HDFS COMMANDS IN HADOOP TERMINAL</center>
...
On click of Reserve button on the pop up window, user would receive an email on registered e-mail ID with the login credentials. The e-mail format would be as shown below:
...
###### <b>Step 9: Tasks in Workspace</b>

Points to Note:

The following files would be made available to the user which will be used for executing this learning lab (DataSource - File):
...
###### <b>Step 10:Launch Hadoop Terminal</b>
...
###### <b>Step 11:Execute Basic Commands</b>
...
1. Create a file in the local system with the content as hello, hadoop-learning-labs. Please follow the command mentioned below to do so:
...
2. Upload file via -put or -copyFromLocal command from local file to HDFS.
...
3. View the uploaded file as follows:
...
###### <b>Step 12: File download from HDFS to local desktop</b>


P.S: if hadoop-learning-labs.txt file exists in local directory then it needs to be deleted first. 

1. Remove file - "hadoop-learning-labs.txt" from local directory if it exists.
...
2. Get the file from HDFS to local directory using -get command
...
###### <b>Step 15:List Files or View File Content in HDFS directory.</b>

<b>Steps Performed:</b>

1. List the files in HDFS directory
...
###### <b>Step 16:Copy, move or remove files in HDFS</b>

1. Create a new directory first.
...
###### <b>Step 17:Delete a file from HDFS.</b>
