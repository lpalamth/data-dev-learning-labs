...
<img src="https://github.com/lpalamth/data-dev-learning-labs/blob/master/labs/HOW TO EXECUTE BASIC COMMAND IN HADOOP TERMINAL/assets/images/HadoopBasic11.png" data-canonical-src="https://github.com/lpalamth/data-dev-learning-labs/blob/master/labs/HOW TO EXECUTE BASIC COMMAND IN HADOOP TERMINAL/assets/images/HadoopBasic11.png" width="240" height="180" border="10" />
...
<b>Download a file from HDFS to local desktop</b>
...
1. Remove a file from local directory if it exists.
2. Get the file from HDFS to local directory using -get command


###### Step 15:

<b>List files or view contents of files in HDFS directory.</b>
...
1. View the contents of the file "hadoop-learning-labs.txt" present in HDFS directory.
2. List the files in HDFS directory

###### Step 16:

<b>Copy, move or remove files in HDFS</b>
