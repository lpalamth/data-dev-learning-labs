...
* In DataSource - File, the following files would be made available to the user which will be used for executing this learning lab:
...
3. View the file uploaded to HDFS as follows:
