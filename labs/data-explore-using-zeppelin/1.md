...
Start following below steps to load the data file and execute Spark code from Zeppelin. </br>
<b>Step 3.1</b> Sample Spark Code for loading data file from Hadoop.
</br> 
Below code is used to load the data file from Hadoop and prepare RDD using Spark. The RDD is converted into a temporary table called "bank"
...
<b>Step 3.2</b> Mark the area where we need to insert th actual bank-full.csv file path. </br>
We need to replace this path in the above code.
...
<b>Step 3.4</b> Update the bank-full.csv file path in the Zeppelin code.</br>
After replaceing the bank-full.csv file path in the spark code, paste the code in Zeppelin editor and it would be like below. Click on the Execute button marked in Red in below image.
...
<b>Step 3.5</b> Execute the code from Zeppelin</br>
