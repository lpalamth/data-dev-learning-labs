...
Below screen shot is showing that the spark RDD is created successfully and creation of a temporary table named "bank" is also done.
...
Data load process is done in above steps. We will use some sql queries to retrive the data and display it in differt format. 
