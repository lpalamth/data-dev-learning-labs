...
**Job Designes::** Job Creation Panel for creating a new transformation job. Details of creating new Talend job will be described in next steps.
**Designer Palette::** For designing a new job, user can use this area to drag and drop differnet components from Pallate. 
