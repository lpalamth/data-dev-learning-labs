...
*Here we are trying to merge First Name and Last Name into one field called FullName in the output file.*
</br>
</br>
**Making connection between each component.**</br>
In this step, we will learn the process of making connection between each component based on the data flow. 
