# <center>Execute Spark program from Hadoop Platform.</center>
...
User can learn Spark programming language by writing code on a Cloud base IDE on top of Hadoop based DLP environment. Execution of a sample WordCount Spark program is described here to learn the understand the process of using IDE. User can get familier about Hadoop environment.
