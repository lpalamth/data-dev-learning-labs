...
DLP platform is pre-populated with workspace for executing different programming languages. For using the Spark programming language, user needs to select the below workspace.
