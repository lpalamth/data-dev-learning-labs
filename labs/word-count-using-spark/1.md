...
<br>
  ...
  Output file: export OUTPIT=output47<br>
...
This will show the number of occurance of each word in the output window. <b>view.sh> file is used to pickup the file from Hadoop environment and show the output in IDE's output window. 
